...
window.ZH = {
  ...
  // design function
  "dz.h1":"工程设计工作台",
  "dz.p":"完整的分步设计流程，含全部设计参数与适用的抗震规定。项目数据（风险类别、场地类别）完全可选 — 尚未确定时留空即可。",
  "dz.ph":"例如：钢筋混凝土梁设计 · 钢柱设计 · 基础设计 · 地震基底剪力 · 施工安全 SMKK",
  "dz.btn":"设计",
  "dz.chip.hse":"🦺 施工安全 SMKK",
  "chip.hse":"🦺 施工安全 SMKK",
  "dz.chip.env":"🌿 环境质量",
  "chip.env":"🌿 环境质量",
  "env.export":"⬇ 导出到 Excel",
  "env.notes":"备注 / 说明：",
  "env.rows":"行",
  "mod.expandAll":"⊞ 全部展开",
  "mod.clickHint":"▾ 点击标题查看详情",
  "mod.clickTable":"▾ 点击标题查看完整表格",
  "env.clickHint":"▾ 点击标题打开完整表格",
  "mod.collapseAll":"⊟ 全部收起",
  "dz.chip.concrete":"🏗 混凝土设计",
  "dz.chip.steel":"🔩 钢结构设计",
  "dz.chip.foundation":"🏚 基础设计",
  "dz.chip.seismic":"🌍 抗震设计",
  "dz.chip.loads":"📐 荷载取值",
  "dz.chip.wind":"🌬 风荷载设计",
  "dz.chip.purlin":"🏠 檩条设计",
  "dz.chip.fire":"🔥 消防设计",
  ...
  "cta.h":"📐 是否继续进入设计功能？",
  "cta.p":"以上为标准中的参考资料。若要据此进行实际设计，请切换到设计功能 — 它保留此处的全部细节，并增加完整的分步设计流程、全套设计参数以及适用的抗震规定。",
  "cta.btn":"进入设计 →",
  "cta.note":"您的问题将自动带入。风险类别与场地类别在设计功能中同样是可选的。",
  "chip.concrete":"🏗 混凝土",
  "chip.steel":"🔩 钢结构",
  ...
  "ctrl.proceed":"开始 →","ctrl.proceedHint":"请在上方选择标准体系（及可选的项目数据），然后点击开始以查看设计流程与参数。",
  "ctrl.notyet":"— 尚未确定 —",
  "ctrl.optNote":"ℹ 两项均为可选。若项目尚未确定，留空即可 — 无论填写与否，均会显示完整的设计流程与全部设计参数；流程中也会说明风险类别与场地类别在相应步骤如何确定。",
  "ctrl.proceedHint2":"请在上方选择标准体系（项目数据可选），然后点击开始，查看完整设计流程与参数。",
  "ctrl.showing":"✓ 当前显示：",
  "mod.noStd":"本模块暂无所选标准体系的专门参数 — 请切换到“全部”或其他标准，或查看上方的对照卡片。",
  "proc.cnNote":"已选择 🇨🇳 中国标准 — 先给出 GB 工作流程；下方编号步骤为 SNI/ASCE 等效顺序，供参考。",
  "proc.usNote":"已选择 🇺🇸 美国标准 — SNI 采标 ASCE/ACI，故此顺序适用；条文号对应 ASCE/ACI。",
  "proc.idNote":"🇮🇩 印尼标准（SNI / Pd-T）— 下方条文号为控制性 SNI 依据。",
  "sec.applicable":"适用标准",
  ...
  "proc.per":"依据：",
  "proc.seismicH":"本流程中的抗震设计参数",
  "proc.seismicNote":"当结构为抗震结构（SDC ≥ C）时，下列取自 SNI 1726 / 1727 / 1729 / 2847 的参数与上方步骤组合，必须同时满足。",
  // AI answer engine
  "ai.title":"工程解答",
...
var TOPIC_ZH={
  ...
  structural_concrete:{name:"结构混凝土",kw:["混凝土","钢筋","保护层","柱","梁","板","剪力墙","配筋","强度等级","砼","强度折减系数","受拉控制","受压控制","净受拉应变","等效应力图","耐久性","暴露等级","硫酸盐","冻融","氯化物","水胶比","抗折模量","混凝土墙","墙厚","承重墙","基础设计","独立基础","承台","筏板","基础厚度","单向受剪","梁受剪","特殊抗弯框架","抗震构造","强柱弱梁","柱约束","塑性铰","加密区","箍筋间距","节点受剪","梁柱节点","约束箍筋","延性构造","抗震等级","锚固长度","锚固","受拉锚固","标准弯钩","弯钩","搭接","搭接接头","搭接长度","弯折直径","扭转","扭矩","开裂扭矩","空间桁架","剪摩擦","摩擦系数","承压","承压强度","正常使用","挠度","挠度限值","裂缝控制","裂缝宽度","有效惯性矩","长期挠度","拉压杆","拉压杆模型","压杆","拉杆","深梁","牛腿","挑耳","节点区","D区","修正系数"]},
  ...
  hse_safety:{name:"职业健康安全环境 / 施工安全（SMKK）",kw:["安全","施工安全","职业健康","安全管理","安全体系","安全生产","危险源","危险源辨识","风险评价","风险等级","安全计划","专项方案","作业许可","动火许可","受限空间","安全交底","班前会","应急预案","应急响应","急救","事故调查","个体防护","防护用品","安全帽","安全带","控制层级","文明施工","安全文明施工费","安全费用","安全员","安全专家","专职安全员","安全巡检","安全审核","零事故","高处作业","临边防护","脚手架安全","基坑安全","日报","周报","月报","施工报告","环境本底","环境监测","环境管理","交通组织","封路","改道","举旗员","交通指挥","竣工验收"]},
  environmental:{name:"环境质量与环境许可",kw:["环境","环境质量","环境标准","质量标准","水质","水质标准","地表水","河流水质","湖泊水质","海水","海水水质","空气质量","环境空气","大气","扬尘","颗粒物","排放","排污","污染","废水","废气","污水","限值","环评","环境影响评价","排污许可","环境批准","环境许可","水体类别","溶解氧","化学需氧量","生化需氧量","悬浮物","大肠菌群","重金属","浊度","盐度","叶绿素","噪声","环保"]}
};
...
var MOD_ZH={
  concrete:{
    ...
    sections:[
      ...
      {h:"单向受剪设计（SNI 2847:2019 §22.5 / ACI 318 第22章）",
       table:{cols:["项目","表达式"],
         rows:[
           ["设计依据","φ·Vn ≥ Vu；Vn = Vc + Vs；φ = 0.75"],
           ["混凝土抗剪（简化）","Vc = <strong>0.17·λ·√fc'·bw·d</strong>（§22.5.5.1）"],
           ["箍筋抗剪（竖向）","Vs = <strong>Av·fyt·d / s</strong>"],
           ["Vs 上限","≤ 0.66·√fc'·bw·d（否则加大截面）"],
           ["最小抗剪钢筋（Vu &gt; 0.5φVc）","Av,min/s = max(0.062·√fc'·bw/fyt , 0.35·bw/fyt)"],
           ["箍筋最大间距","≤ d/2 ≤ 600 mm；Vs &gt; 0.33·√fc'·bw·d 时 ≤ d/4 ≤ 300 mm"]
         ]},
       notes:["λ = 1.0（普通混凝土）、0.75（全轻混凝土）。双向（冲切）剪切见冲切卡片。🇨🇳 GB 50010：V ≤ 0.7·βh·ft·b·h0 + fyv·Asv·h0/s（§6.3）。"]},
      {h:"构件尺寸 — 控制挠度的最小厚度（SNI 2847:2019 第7–9章）",
       table:{center:true,cols:["构件 / 支承","最小 h（fy = 420 MPa）"],
         rows:[
           ["单向板 — 简支","ℓ/20"],
           ["单向板 — 一端连续","ℓ/24"],
           ["单向板 — 两端连续","ℓ/28"],
           ["单向板 — 悬臂","ℓ/10"],
           ["梁 — 简支/一端连续/两端连续/悬臂","ℓ/16 · ℓ/18.5 · ℓ/21 · ℓ/8"],
           ["双向无梁板 — 边区格/内区格","ln/30 · ln/33（最小 125 mm）"]
         ]},
       notes:["fy ≠ 420 MPa 时乘 (0.4 + fy/700)。轻混凝土另加系数（§7.3.1.1.2）。若更薄须算挠度并满足表 24.2.2（屋面瞬时 L/180、活载 L/360、总 L/240、支承脆性构件 L/480）。"]},
      {h:"墙（SNI 2847:2019 第 11 章）",
       table:{cols:["参数","要求"],
         rows:[
           ["最小厚度 — 承重墙","取 100 mm 与 1/25 × min(无支撑长度, 高度) 中较大者（表 11.3.1.1）"],
           ["最小厚度 — 非承重墙","取 100 mm 与 1/30 × min(长度, 高度) 中较大者"],
           ["最小厚度 — 地下室/基础墙","≥ 190 mm"],
           ["最小竖向配筋率 ρℓ","0.0012（带肋 ≤ D16，fy ≥ 420）；否则 0.0015"],
           ["最小水平配筋率 ρt","0.0020（带肋 ≤ D16，fy ≥ 420）；否则 0.0025"],
           ["墙筋最大间距","≤ 3·h 且 ≤ 450 mm；h &gt; 250 mm 时须双层布置"],
           ["轴力设计（简化 §11.5.3）","φPn = 0.55·φ·fc'·Ag·[1 − (k·ℓc/32h)²]，φ = 0.65"]
         ]},
       notes:["抗震特殊（剪力）墙按第 18.10 章增设边缘构件并提高配筋率。🇨🇳 GB 50010 §9.4 / JGJ 3：墙最小厚度 160–200 mm，分布钢筋 ρ ≥ 0.20–0.25%。"]},
      {h:"基础（SNI 2847:2019 第 13 章）",
       table:{cols:["项目","要求"],
         rows:[
           ["涵盖的基础类型","条形、独立（扩展）、联合、筏板、地梁（sloof）、承台、桩、钻孔墩、沉箱（§13.1.1）"],
           ["底筋以上最小基础高度","<strong>≥ 150 mm</strong>（置于土上）；<strong>≥ 300 mm</strong>（置于桩上）（§13.3.1.2）"],
           ["Mu 临界截面","柱/墙边缘处（表 13.2.7.1）"],
           ["单向（梁式）受剪","距柱边 d 处验算；Vc = 0.17·λ·√fc'·bw·d"],
           ["双向（冲切）受剪","距柱 d/2 周边验算 — 见冲切卡片"],
           ["最小受弯钢筋","As,min = 0.0018·Ag（收缩/温度），按 §13.3 分布"],
           ["柱脚力传递","插筋穿过界面；最小插筋面积 0.005·Ag（§16.3）"]
         ]},
       notes:["地基承载力与沉降由 SNI 8460:2017 控制（见基础类型与岩土模块）。🇨🇳 GB 50007 控制中国基础设计；ACI 318 第13章 = SNI 2847 第13章。"]},
      {h:"抗震构造 — 体系分类（SNI 2847:2019 第 18 章 / ACI 318-19 第 18 章）",
       ...
       notes:["SRPMK ≈ ACI 318 特殊抗弯框架。详细的梁/柱/节点要求见下文。"]},
      {h:"SRPMK 特殊抗弯框架 — 梁（SNI 2847:2019 §18.6）",
       table:{cols:["参数","要求"],
         rows:[
           ["几何","净跨 ≥ 4d；宽 ≥ 0.3h 且 ≥ 250 mm（§18.6.2）"],
           ["纵向配筋","ρ = As/(bw·d)：≥ As,min（0.25√fc'/fy 与 1.4/fy），≤ <strong>0.025</strong>；顶/底各 ≥ 2 根通长（§18.6.3.1）"],
           ["节点面正弯矩","≥ 该处负弯矩承载力的 0.5 倍（§18.6.3.2）"],
           ["箍筋加密区","自每个柱面起 <strong>2h</strong> 范围及任一受弯屈服截面两侧 2h（§18.6.4.1）"],
           ["首箍","距柱面 ≤ 50 mm"],
           ["加密区箍筋间距","≤ min(<strong>d/4、6·db、150 mm</strong>)（§18.6.4.4）"],
           ["非加密区箍筋间距","≤ d/2（两端抗震弯钩）（§18.6.4.6）"]
         ]},
       notes:["设计剪力由梁端概率弯矩 Mpr（取 1.25·fy）+ 重力（能力设计，§18.6.5）；当地震剪力 ≥ 0.5·Vu 且 Pu &lt; Ag·fc'/20 时加密区 Vc = 0。"]},
      {h:"SRPMK 特殊抗弯框架 — 柱（SNI 2847:2019 §18.7）",
       table:{cols:["参数","要求"],
         rows:[
           ["几何","最小截面 ≥ <strong>300 mm</strong>；短边/长边 ≥ 0.4（§18.7.2）"],
           ["强柱弱梁","每个节点 <strong>ΣMnc ≥ (1.2)·ΣMnb</strong>（§18.7.3.2）"],
           ["纵向配筋","0.01·Ag ≤ Ast ≤ 0.06·Ag（§18.7.4.1）"],
           ["约束区长度 Lo","取：节点处柱高、净高/6、450 mm 中较大者（§18.7.5.1）"],
           ["Lo 内箍筋间距","≤ min(b/4、6·db、so)；so = 100 + (350−hx)/3，100 ≤ so ≤ 150 mm（§18.7.5.3）"],
           ["约束用量 Ash（矩形）","≥ 0.3·(Ag/Ach−1)·fc'/fyt 与 0.09·fc'/fyt 较大者（表 18.7.5.4）"],
           ["螺旋配箍率 ρs","≥ 0.45·(Ag/Ach−1)·fc'/fyt 与 0.12·fc'/fyt 较大者"]
         ]},
       notes:["当 Pu &gt; 0.3·Ag·fc' 或 fc' &gt; 70 MPa 时附加约束系数 kf 与 kn（表 18.7.5.4）。hx = 受侧向支撑钢筋的最大水平间距 ≤ 350 mm。"]},
      {h:"SRPMK 梁柱节点（SNI 2847:2019 §18.8）",
       table:{center:true,cols:["节点约束","名义抗剪 Vn"],
         rows:[
           ["四面均有梁约束","<strong>1.7·√fc'·Aj</strong>"],
           ["三面或两相对面约束","1.25·√fc'·Aj"],
           ["其他（无约束）节点","1.0·√fc'·Aj"]
         ]},
       notes:["Aj = 有效节点面积；节点受剪 φ = 0.85。柱横向钢筋须穿过节点；梁筋伸入节点锚固 ldh 按 §18.8.5。"]},
      {h:"受拉锚固长度 — 变形钢筋（SNI 2847:2019 §25.4.2）",
       table:{center:true,cols:["量","表达式 / 取值"],
         rows:[
           ["一般公式 ℓd","ℓd = [ fy·ψt·ψe·ψs / (1.1·λ·√fc'·((cb+Ktr)/db)) ]·db"],
           ["约束项 (cb+Ktr)/db","≤ 2.5（更大则拔出破坏，无增益）"],
           ["横向钢筋指标 Ktr","Ktr = 40·Atr / (s·n)；允许取 Ktr = 0（偏保守）"],
           ["简化式（D19 及以下，间距充足）","ℓd = [ fy·ψt·ψe / (2.1·λ·√fc') ]·db"],
           ["简化式（D22 及以上，间距充足）","ℓd = [ fy·ψt·ψe / (1.7·λ·√fc') ]·db"],
           ["绝对最小值","ℓd ≥ 300 mm"]
         ]},
       notes:["修正系数：ψt = 1.3（顶部钢筋，其下新浇混凝土 >300 mm）否则 1.0；ψe = 1.5（环氧、保护层<3db 或净间距<6db）/ 1.2（其他环氧）/ 1.0（无涂层）；ψs = 0.8（D19 及以下）/ 1.0（D22 及以上）；λ = 0.75 轻质、1.0 普通。乘积 ψt·ψe ≤ 1.7。","算例（fc'=28 MPa、420 级、普通混凝土、无涂层、D22）：ℓd ≈ 47·db（间距有利）至 72·db（cb+Ktr/db=1.0）。"]},
      {h:"锚固 — 标准弯钩与受压钢筋（SNI 2847:2019 §25.4.3 / §25.4.9）",
       table:{center:true,cols:["锚固类型","锚固长度"],
         rows:[
           ["受拉标准弯钩 ℓdh","ℓdh = [ 0.24·ψe·ψc·ψr·fy / (λ·√fc') ]·db ≥ max(8db, 150 mm)"],
           ["  ψe（环氧）","1.2 环氧 / 1.0 无涂层"],
           ["  ψc（保护层）","D36 及以下、侧保护层 ≥65 mm 且 90° 尾端保护层 ≥50 mm 取 0.7；否则 1.0"],
           ["  ψr（约束）","若被垂直箍筋/系筋包围且 s ≤ 3db 取 0.8；否则 1.0"],
           ["受压锚固 ℓdc","max( [0.24·fy·ψr/(λ·√fc')]·db , 0.043·fy·ψr·db ) ≥ 200 mm"],
           ["  ψr（受压、约束）","螺旋/D13 箍@≤100 mm/约束箍@≤100 mm 取 0.75；否则 1.0"]
         ]},
       notes:["标准弯钩几何（表 25.3.1）：90° 弯钩 = 弯折 + 12db 直段延伸；180° 弯钩 = 弯折 + max(4db, 65 mm)。最小内弯直径：6db（D10–D25）、8db（D29–D36）、10db（D43–D57）。箍筋/系筋弯折（表 25.3.2）：D16 及以下 4db，D19–D25 6db；抗震弯钩 = 135° 弯折 + 6db（≥75 mm）延伸。"]},
      {h:"搭接接头（SNI 2847:2019 §25.5）",
       table:{center:true,cols:["搭接类型","所需搭接长度"],
         rows:[
           ["受拉 — A 级","1.0·ℓd ≥ 300 mm — 仅当 As,配置/As,需要 ≥ 2 且搭接内接头 ≤ 50% 钢筋时允许"],
           ["受拉 — B 级（默认）","1.3·ℓd ≥ 300 mm"],
           ["受压（fy ≤ 420 MPa）","ℓsc = max( 0.071·fy·db , 300 mm )"],
           ["受压（fy > 420 MPa）","ℓsc = max( (0.13·fy − 24)·db , 300 mm )"],
           ["受压、fc' < 21 MPa","ℓsc 增加 1/3"],
           ["机械 / 焊接接头","须发挥 ≥ 1.25·fy"]
         ]},
       notes:["此处 ℓd 按 §25.4.2.1(a)，不考虑超配钢筋折减。除 §25.5.5.3 另有规定外，大于 D36 的钢筋不得使用搭接。非接触搭接横向间距 ≤ min(搭接长/5, 150 mm)。"]},
      {h:"扭转设计（SNI 2847:2019 §22.7 — 空间桁架模型）",
       table:{center:true,cols:["量","表达式"],
         rows:[
           ["扭转阈值 Tth（实心、非预应力）","φ·0.083·λ·√fc'·(Acp²/pcp) — 若 Tu < φ·Tth 可忽略扭转"],
           ["开裂扭矩 Tcr","0.33·λ·√fc'·(Acp²/pcp)"],
           ["名义扭矩 Tn","min[ 2·Ao·At·fyt·cotθ / s ,  2·Ao·Al·fy·cotθ / ph ]"],
           ["剪流包围面积 Ao","0.85·Aoh（Aoh = 最外层封闭箍中心线所围面积）"],
           ["受压斜杆倾角 θ","30°–60°（非预应力常取 45°）"],
           ["截面适用性限值","√[(Vu/bw·d)² + (Tu·ph/1.7·Aoh²)²] ≤ φ·(Vc/bw·d + 0.66·√fc')"]
         ]},
       notes:["φ = 0.75（扭转）。扭转计算中 √fc' 限于 8.3 MPa，fy、fyt ≤ 420 MPa。混凝土对 Tn 贡献为零 — 全部扭矩由封闭箍筋 + 纵筋承担。平衡扭转不可重分布；协调扭转可取上限 φ·Tcr。"]},
      {h:"承压与剪摩擦（SNI 2847:2019 §22.8 / §22.9）",
       table:{center:true,cols:["验算","名义强度"],
         rows:[
           ["承压 — 一般","Bn = 0.85·fc'·A1（φ = 0.65）"],
           ["承压 — 支承四周更宽","Bn = min(√(A2/A1), 2)·0.85·fc'·A1"],
           ["剪摩擦（钢筋 ⊥ 面）","Vn = μ·Avf·fy  →  Avf = Vu / (φ·μ·fy)"],
           ["μ — 整体浇筑混凝土","1.4·λ"],
           ["μ — 凿毛冷缝（振幅约 6 mm）","1.0·λ"],
           ["μ — 未凿毛冷缝","0.6·λ"],
           ["μ — 混凝土锚固于轧制钢材","0.7·λ"]
         ]},
       notes:["λ = 1.0 普通、0.75 轻质。Vn 上限（普通混凝土浇于凿毛面）：min(0.2·fc'·Ac, (3.3+0.08·fc')·Ac, 11·Ac)；其他取 min(0.2·fc'·Ac, 5.5·Ac)。作用于面上的永久净压力可叠加至 Avf·fy。剪摩擦钢筋须在面两侧均发挥 fy。"]},
      {h:"正常使用 — 挠度与裂缝控制（SNI 2847:2019 第 24 章）",
       table:{center:true,cols:["构件 / 条件","计算挠度限值"],
         rows:[
           ["平屋面，无非结构构件","ℓ/180（Lr + R 瞬时）"],
           ["楼面，无非结构构件","ℓ/360（L 瞬时）"],
           ["屋面/楼面支承易损非结构构件","ℓ/480（长期 + 安装后活载瞬时）"],
           ["屋面/楼面支承不易损非结构构件","ℓ/240"],
           ["有效惯性矩 Ie","(Mcr/Ma)³·Ig + [1−(Mcr/Ma)³]·Icr ≤ Ig"],
           ["开裂弯矩 Mcr","fr·Ig / yt,  fr = 0.62·λ·√fc'"],
           ["长期挠度乘数 λΔ","ξ / (1 + 50·ρ')"]
         ]},
       notes:["时间系数 ξ = 1.0（3 个月）/ 1.2（6 个月）/ 1.4（12 个月）/ 2.0（≥5 年）。裂缝控制（§24.3.2）：最大钢筋间距 s = min[ 380·(280/fs) − 2.5·cc , 300·(280/fs) ]，其中 fs 可取 (2/3)·fy，cc = 至最近表面的净保护层。"]},
      {h:"拉压杆模型 — D 区（SNI 2847:2019 第 23 章）",
       table:{center:true,cols:["构件","有效混凝土强度 / 系数"],
         rows:[
           ["压杆名义强度 Fns","fce·Acs（有配筋加 As'·fs'）；fce = 0.85·βs·fc'"],
           ["βs — 棱柱形（均匀）压杆","1.0"],
           ["βs — 瓶形压杆 有裂缝钢筋（§23.5）","0.75"],
           ["βs — 瓶形压杆 无裂缝钢筋","0.60·λ"],
           ["βs — 受拉构件/受拉区压杆","0.40"],
           ["节点区强度","fce = 0.85·βn·fc'"],
           ["βn — C-C-C（由压杆/支承围合）","1.0"],
           ["βn — C-C-T（锚固一根拉杆）","0.80"],
           ["βn — C-T-T（锚固 ≥ 两根拉杆）","0.60"]
         ]},
       notes:["拉压杆模型 φ = 0.75。进入节点的压杆与拉杆夹角 ≥ 25°。拉杆屈服：Fnt = Ats·fy（加预应力）。用于深梁、牛腿/挑耳（a/d ≤ 2）、桩承台等平截面假定不成立的不连续（D）区。"]},
    ],
    sources:"SNI 2847:2019 表 21.2.1 与 21.2.2（φ）、§22.2（β1、εcu）、§19.2–19.3（耐久性）、§22.5（受剪）、§22.7（扭转）、§22.8（承压）、§22.9（剪摩擦）、第23章（拉压杆）、第24章（挠度/裂缝）、§25.4（锚固）、§25.5（搭接）、表 25.3.1–25.3.2（标准弯钩）、第7–9章（尺寸）、第11章（墙）、第13章（基础）、§18.6–18.8（SRPMK）— 提取自 PDF · SNI 2052:2017（钢筋） · GB 50010-2010 与 GB 50011 · ACI 318-19（= SNI 2847）"
  },
  steel:{
    title:"钢结构 — 设计参数",
    sections:[
  ...
  hse:{
    title:"职业健康安全环境（HSE）— 印尼施工安全管理体系 SMKK",
    sections:[
      {h:"SMKK 体系 — 强制性安全文件（部长条例 PUPR 10/2021 附件）",
       table:{center:true,cols:["文件","编制方 / 阶段","作用"],
         rows:[
           ["<strong>SMKK 概念设计</strong>（Rancangan Konseptual SMKK）","咨询方（勘察/规划/设计阶段）","针对施工图的危险源辨识、风险等级声明、安全费用与人员需求、运维安全指南"],
           ["<strong>RKK</strong> — 施工安全计划","承包方 — 投标时提交，签约时定稿","核心施工安全计划；含 5 大要素（见下）。分为监理 RKK 与施工 RKK"],
           ["<strong>RMPK</strong> — 施工质量计划","承包方（施工）","施工方法、检验试验计划（ITP）、各工序质量控制"],
           ["<strong>Program Mutu</strong> — 质量纲要","咨询方","咨询服务的质量管理纲要"],
           ["<strong>RKPPL</strong> — 环境管理与监测工作计划","承包方","环境管理与监测计划"],
           ["<strong>RMLLP</strong> — 施工交通组织计划","承包方","基于双向日交通量数据的交通组织方案"]
         ]},
       notes:["SMKK 覆盖建设全过程 — 勘察 → 规划 → 设计 → 采购 → 施工 → 运维。管理层级分为两类：<strong>基础设施实施方</strong>（政策制定、技术指导、监督 — 负责安全保障）与<strong>项目实施方</strong>（PPK、现场总监、监理、承包方 — 负责现场安全控制）。"]},
      {h:"施工安全风险等级 — IBPRP（部长条例 PUPR 10/2021 附件 C 与 D）",
       table:{center:true,cols:["项目","规定"],
         rows:[
           ["风险值","<strong>TR = K × A</strong> — 发生频率（Kekerapan）× 严重程度（Keparahan）"],
           ["风险等级","<strong>小 / 中 / 大</strong>（Kecil / Sedang / Besar），须签署《风险等级确定声明》正式发布"],
           ["按 5 类受体评估","作业人员 · 设备 · 材料 · 公众 · 生态环境 — 多风险分析，各自评定 K、A 与 TR"],
           ["风险等级的用途","确定<strong>所需安全人员配置</strong>（施工安全专家/K3 专家 vs 安全员）及 UKK 组织形式 — 明确不用于划分市场或工程复杂度"],
           ["IBPRP 表","危险源辨识 → 风险评价 → 风险控制 → 后续措施，由施工安全专家 / K3 专家签署"],
           ["AKK（施工安全分析）","<strong>中、大风险</strong>作业强制编制，并办理专项作业许可（izin kerja khusus）"]
         ]},
       notes:["危险源辨识须由实际施工方法推导；风险控制分析须综合工程技术控制、管理控制、人的行为以及变更管理（manajemen perubahan）。"]},
      {h:"IBPRP 评分与剩余风险 — 16 栏表格（部长条例 PUPR 10/2021 表 2-2）",
       table:{center:true,cols:["栏目组","内容"],
         rows:[
           ["风险描述（1–5 栏）","序号 · 作业内容（例行与非例行，取自施工进度表）· 危险源辨识 · 针对 4 类受体的风险（人员 / 设备 / 材料 / 环境-公众）· 适用法规或其他要求"],
           ["风险等级评价（6–9 栏）","<strong>可能性 F — 1–5 级</strong> · <strong>严重度 A — 1–5 级</strong> · 风险值 = <strong>F × A</strong> · 初始风险等级（TR）"],
           ["初始风险控制（10 栏）","按层级顺序填写：1 消除 · 2 替代 · 3 工程技术 · 4 管理 · 5 个体防护"],
           ["剩余风险评价（11–14 栏）","实施初始控制后重新评分：可能性（F）· 严重度（A）· 风险值（F × A）· <strong>剩余风险等级</strong>"],
           ["后续控制（15–16 栏）","剩余风险仍不可接受时须采取的追加措施 · 备注"]
         ]},
       notes:["可能性/发生频率 = 施工安全危险事件发生的频繁程度（1–5 级）。严重度 = 危险源造成的伤害、损失或破坏程度（1–5 级）。风险等级为两者的组合。","分档现已依据<strong>附件 J 表 J-3</strong> 正式矩阵确认：<strong>1–4 = 小 · 5–12 = 中 · 15–25 = 大</strong>（K 与 A 的完整分级见下方专节）。","IBPRP 由施工负责人签署。控制层级定义（部长条例 PUPR 10/2021）：<em>消除</em> = 不安排人员从事该作业以消除危险；<em>替代</em> = 更换工艺、操作、材料或设备；<em>工程技术</em> = 通过设备与作业场所的设计进行控制；<em>管理控制</em> = 程序、作业许可、作业安全分析与能力提升；<em>APD/APK</em> = 配备充分的个体与作业防护装备。"]},
      {h:"风险控制层级（部长条例 PUPR 10/2021 附件 D.2）",
       table:{center:true,cols:["顺序","控制层级","含义"],
         rows:[
           ["1","<strong>消除</strong>（Eliminasi）","彻底消除危险源"],
           ["2","<strong>替代</strong>（Substitusi）","以危害更小的工法/材料替代"],
           ["3","<strong>工程技术控制</strong>（Rekayasa teknis）","防护、隔离、设计变更"],
           ["4","<strong>管理控制</strong>（Administratif）","程序、许可、培训、标识、轮岗"],
           ["5","<strong>个体与作业防护</strong>（APD &amp; APK）","个人防护用品 + 作业防护装备 — 最后手段"]
         ]},
       notes:["控制后须重新评价剩余风险（pengendalian risiko lanjutan）— 剩余风险不可接受时须追加措施。"]},
      {h:"RKK 五大要素（部长条例 PUPR 10/2021 附件 D.2）",
       table:{center:true,cols:["#","要素","最低子要素"],
         rows:[
           ["1","<strong>领导力与员工参与</strong>","管理层对内外部问题的关注；SMKK（UKK）组织架构及职责；员工协商与参与"],
           ["2","<strong>策划</strong>","IBPRP；目标与方案（总体 + 针对中/大优先级风险的专项）；安全法规与标准符合性"],
           ["3","<strong>支持</strong>","资源 — 技术与设备（准用证、检验合格证、操作人员执照）、材料（进口清单、B3 危化品 MSDS）、<strong>含 9 项组成的 SMKK 费用</strong>；人员能力；安全意识与培训；沟通（安全交底、班前会）；文件化信息"],
           ["4","<strong>运行</strong>","RKK 实施与组织；运行控制 — AKK 与专项许可、作业环境安全、起重机械与设备准用、个体防护程序、分包与供应商控制、职业健康与社会保障、环境管理（5R、防污染、废弃物）；应急准备与响应；事故调查"],
           ["5","<strong>绩效评价</strong>","按既定计划与检查表进行监测/巡检；按 RKK 准则审核；合规性评价；管理评审；持续改进"]
         ]},
       notes:["直接委托（penunjukan langsung）同样须编制完整 RKK。自营（swakelola）工程的 RKK 至少应包含 IBPRP、AKK、巡检计划及 APD/APK 采购；自营监理则至少包含危险源辨识与目标方案。"]},
      {h:"UKK — 施工安全单元与人员配置（部长条例 PUPR 10/2021 附件 A 与 D）",
       table:{center:true,cols:["风险等级","UKK 负责人","典型人员"],
         rows:[
           ["<strong>小风险</strong>","UKK 负责人职能由项目最高负责人兼任（不单设）","安全员（Petugas Keselamatan Konstruksi）；急救员"],
           ["<strong>中、大风险</strong>","<strong>单设 UKK 负责人</strong>，与项目负责人直接协调","施工安全专家 / K3 专家；施工安全协调员；应急协调员；UKK 成员"]
         ]},
       notes:["标准 UKK 人员配置（表 8）：施工安全人员 · 急救员（P3K）· 应急人员 · 交通指挥员（flagman）· 医护人员 · 质量保证人员。职责（附件 D）：UKK 负责人确保 SMKK 要求落实；安全员制定安全目标、组织安全交底、开展巡检、协调并上报事故；应急人员发布应急信息并上报安全主管；医护人员实施现场急救并对接医疗机构；交通管理人员编制并执行 RMLLP；环境管理人员编制环境方案并巡检现场。","监理咨询（监理 RKK）人员清单须含 K3/施工安全专家、K3/安全员及相应专业技术专家，并附证书（如施工 K3 初级专家证）。"]},
      {h:"领导承诺与员工参与（部长条例 PUPR 10/2021 附件 A.3–A.4）",
       table:{cols:["要求","规定"],
         rows:[
           ["管理层现场巡视","由企业负责人（或其下一级）按计划到项目巡视 — <strong>表 1-2 承包方负责人巡视计划</strong>，按月编排"],
           ["巡视目的","(a) 与作业人员直接讨论现场施工安全问题；(b) 提出解决方案；(c) 针对发现的违章行为强化纪律"],
           ["员工协商与参与","<strong>表 1-3 员工沟通与参与方案</strong> — 须形成文件化方案，不得临时随意安排"],
           ["监督与问责","附件 A.4 — 监督、培训、问责、资源与支持均须落实到人并留有证据"],
           ["安全文化方案","按风险等级制定意识提升程序 + 预防不安全行为的承诺 + 面向全员的施工安全文化培育方案，由施工负责人与施工安全负责人共同签署"]
         ]},
       notes:["管理层巡视的明确目的是核实 RKK 是否真正落实并提升员工参与度 — 属于合规记录，其计划与执行情况均可被审核。"]},
      {h:"安全沟通方案（部长条例 PUPR 10/2021 附件 C.4，表 3-8）",
       table:{center:true,cols:["活动","参加人员","频次 / 触发条件"],
         rows:[
           ["<strong>安全交底</strong>（safety induction）","新进人员、转岗人员、来访者、供应商及其他进入作业区域的相关方","首次进入施工区域前"],
           ["<strong>班前会</strong>（safety morning）","<strong>全体作业人员</strong>","<strong>每日开工前</strong>"],
           ["<strong>班组会</strong>（toolbox meeting）","相应作业班组","该班组开工前"],
           ["<strong>施工安全例会</strong>（construction safety meeting）","由施工安全负责人和/或施工负责人主持；<strong>各单位负责人</strong>参加","按沟通计划执行"],
           ["危险信息告知","全体人员 — 内容按作业风险等级确定","持续开展"],
           ["HSE 统计看板与公告栏","全场展示","持续维护"]
         ]},
       notes:["上述每项程序/作业指导书均须形成文件，由施工安全负责人与施工负责人签署，并全部纳入《沟通方案计划表》（表 3-8），逐项明确责任人。"]},
      {h:"专项作业许可与 AKK / 施工安全分析（附件 D.2，表 4-2 与 4-3）",
       table:{center:true,cols:["项目","规定"],
         rows:[
           ["AKK / CSA 内容","作业步骤分解 — <strong>不超过 10 项</strong> — 逐步分析危险与控制措施，须综合考虑材料、人员、方法/程序、设备与环境"],
           ["许可证流转","一式三份：原件由<strong>发包方</strong>作为文件化信息保存，第二份由<strong>承包方</strong>保存，第三份由<strong>监理</strong>保存；由 UKK 签发"],
           ["许可作业类别（11 类）","动火作业（任何可产生火源的作业）· 开挖作业 · 起重吊装 · 受限空间（自然通风不良、含可燃和/或有毒气体）· 潜水作业 · 冷作业（上述之外的全部作业）· 夜间作业（超出正常工时）· 高处作业 · 脚手架作业 · 射线（X 光）作业 · 带电作业"]
         ]},
       notes:["中、大风险作业均须同时编制 AKK 并办理专项作业许可（附件 D.2 要素 4）。AKK 表须记录许可申请人、作业内容、作业日期、监督人及所属部门。"]},
      {h:"SMKK 检查表 — 内部审核检查清单（表 1）",
       notes:["正式审核工具：<strong>86 项准则</strong>，覆盖 RKK 五大要素与 15 个子要素，每项按 <strong>SESUAI / MINOR / MAJOR</strong> 结合观察结果评定。审核人员或发包方在现场核查 SMKK 落实情况时即依此表逐项检查。"]},
      {h:"施工安全监测检查清单 — 现场巡查（表 2）",
       notes:["审核表的现场配套工具 — 每次监测巡访填写，涵盖 7 个类别：技术文件准备、安全规定符合性、持证人员、设备准用（SILO）、材料质量、技术准用性及标准作业程序执行。多项内容专门由<strong>大风险</strong>作业触发。"]},
      {h:"监测、巡检与绩效评价（部长条例 PUPR 10/2021 附件 E）",
       table:{cols:["活动","要求"],
         rows:[
           ["巡检目的","发现不符合标准的状态与行为及技术性不符合项，以识别潜在危险源"],
           ["巡检周期","检查表（lembar periksa）按规定周期签署 — <strong>日检、周检或月检</strong>"],
           ["必备检查表范围","作业范围 · 起重运输机械（重型设备）· 工器具 · 材料 · 环境（现场整理、污染、卫生）· 健康 · 治安"],
           ["签署要求","各检查表由相应专业技术专家与施工安全负责人签署；材料检查表还须经监理批准"],
           ["审核与评审","按 RKK 准则审核 → 合规性评价 → 管理评审 → 纠正措施与持续改进"]
         ]},
       notes:["绩效评价的核心是判断 SMKK 各项控制是否真正产生效益，依据为施工报告及所采取的纠正与改进措施。巡检结果按《RKK 实施报告附件》中的表格填报。"]},
      {h:"施工报告制度（部长条例 PUPR 10/2021 附件 I — 实施报告）",
       table:{center:true,cols:["报告","报送期限","份数","审批链"],
         rows:[
           ["<strong>日报</strong>（Laporan Harian）","<strong>每日</strong>","4","承包方<em>编制</em> → 技术总监/监理<em>审查</em> → 现场总监/项目管理咨询<em>批准</em> → 项目负责人<em>知悉</em>"],
           ["<strong>周报</strong>（Laporan Mingguan）","<strong>次周星期一</strong>","3","同上"],
           ["<strong>月报</strong>（Laporan Bulanan）","<strong>次月 10 日</strong>","3","同上"],
           ["监理 — 周报","次周星期一","3","监理<em>编制</em> → 现场总监<em>批准</em> → 项目负责人<em>知悉</em>"],
           ["监理 — 月报","次月 10 日","3","同上"],
           ["监理 — 专项报告","<strong>按情况需要</strong>","3","同上"],
           ["监理 — 最终报告","<strong>PHO（初步验收）之后</strong>","3","同上"]
         ]},
       notes:["咨询服务报告内容（表 6-1）：<strong>开工报告</strong> — 对服务范围的理解、工作计划与组织、进度计划与专家安排；<strong>月报</strong> — 当月工作计划、承包方进度、总体进度及<em>延误情况与原因</em>、次月计划、专家进度计划；<strong>季报</strong> — 工作计划、截至最近一季的进展、下一季度计划、阶段性评价与对发包方的建议；<strong>最终报告</strong> — 初始与调整后的工作计划、监理实施情况、专家投入的实际执行情况。","报告是附件 E 中 SMKK 绩效评价的证据基础 — 巡检表与环境检查报告作为《RKK 实施报告》的附件归档。"]},
      {h:"RKPPL — 环境管理与监测工作计划（部长条例 PUPR 10/2021 附件 G）",
       table:{cols:["部分","内容"],
         rows:[
           ["文件结构","封面 · 签认页 · 目录 · 第一章（技术资料、组织架构）· 第二章 环境本底状况 · 第三章 环境管理与监测工作计划"],
           ["环境本底 — 线性工程（道路、排水）","<strong>按桩号（STA）</strong>记录本底状况，<strong>左右两侧分别</strong>附照片与简要描述 — 覆盖项目区、料场（quarry）、料场运输路线及营地"],
           ["环境本底 — 房屋建筑工程","照片 + 本底描述 + 位置，例如进场道路状况、相邻居民区、清真寺、小区主路"],
           ["环境工作计划（表 3.1）","6 栏：位置/桩号 · 环境影响 · 产生影响的作业 · <strong>环境管理措施</strong> · 环境监测措施 · 本底对照"],
           ["监测方式","对管理措施进行目视观察 + 对每项环境管理活动进行<strong>照片记录</strong>"]
         ]},
       notes:["<strong>关键衔接规则：</strong>若工程已办理环境文件（AMDAL 或 UKL-UPL），RKPPL 工作计划表必须<em>纳入并细化</em> RKL/RPL 或 UKL/UPL 的要求与条款；若工程未办理该类文件，则第 5 栏必须依据各分项工程的标准作业程序（SOP），逐项列出每一环境与社会影响的缓解措施 — 即任何情况下均不得留白。","条例给出的示例包括：开挖料当日即运离以避免堆积、清理开挖遗撒的泥土、按侧向小巷间距分段施工以便实施改道与交通组织。"]},
      {h:"RMLLP — 施工交通组织计划（部长条例 PUPR 10/2021 附件 H）",
       table:{cols:["项目","要求"],
         rows:[
           ["适用条件","任何与公共交通交叉的施工作业"],
           ["分阶段分析","(1) 判定属<strong>长期或短期</strong>作业；(2) 确定作业阶段 — 作业区周边通行、全封闭管制下穿越、或不进入作业区的绕行"],
           ["文件结构","第一章 概述（16 项工程基本信息、位置图、RMLLP 范围）· 第二章 交通组织方案（交通流分析）· 第三章 活动报告"],
           ["须策划的 13 项要素","改道 · 临时便桥 · 临时封路 · 临时便道 · 交通组织分区 · 临时道路设施 · 交通指挥人员（<strong>含举旗员</strong>）· 公共道路与营地/料场/堆场进出口的交叉点 · 施工段车道的起止点 · 与施工便道的交叉点 · 临时便桥位置 · 其他存在公共交通与工程车辆冲突风险的位置"],
           ["部门协调（表 3）","各要素须与<strong>交通局（Dinas Perhubungan）</strong>、<strong>警察局交警队（Satlantas Polres/Polresta）</strong>及 <strong>PUBM</strong> 协调"],
           ["封路计划（表 5）","按分区/位置列出：作业内容、时间（分<strong>周一至周五 / 周六至周日</strong>）、节假日与特殊时段（如斋月）以及协调前后识别出的特殊制约条件"]
         ]},
       notes:["<strong>每日义务（第三章）：</strong>道路作业期间必须<em>每天</em>进行观察与评价。须编制并归档书面记录（日期／时间／结果／执行人）以备日后查证。每日观察须涵盖 RMLLP 中列明的全部设施与标志 — 若标志损坏或围挡倾倒，须记录在案并<strong>作为最高优先事项立即修复</strong>。","审批链：由承包方编制（经最高负责人／现场经理／项目经理签署），由监理咨询方（现场／监理工程师）审查，并由发包方<strong>在施工准备会（合同实施准备会议）上批准</strong>。"]},
      {h:"风险等级正式判定准则 — 表 J-3 矩阵与第 34 条（部长条例 PUPR 10/2021）",
       table:{center:true,cols:["判定依据","🟢 小（Kecil）","🟡 中（Sedang）","🔴 大（Besar）"],
         rows:[
           ["<strong>风险值 TR = K × A</strong>","<strong>1 – 4</strong>","<strong>5 – 12</strong>","<strong>15 – 25</strong>"],
           ["危险性质（依 RKK 评价）","低危","中危","高危"],
           ["设计概算（HPS）","≤ <strong>100 亿盾</strong>","&gt; 100 亿 – <strong>1000 亿盾</strong>","&gt; <strong>1000 亿盾</strong>"],
           ["施工人数","&lt; <strong>25</strong> 人","<strong>25 – 100</strong> 人","&gt; <strong>100</strong> 人"],
           ["技术水平","简单（sederhana）","中等（madya）","高（tinggi）"],
           ["大风险附加触发条件","—","—","使用<strong>起重机械</strong>（pesawat angkat）；采用<strong>爆破</strong>工法或可能引发爆炸的作业"]
         ]},
       notes:["<strong>发生频率 K（表 J-2a），1–5 级：</strong>5 = 几乎必然发生，作业时极可能发生事故，1 年内 &gt;2 次 · 4 = 很可能发生，几乎所有工况下均可能发生，最近 1 年内 1 次 · 3 = 可能发生，特定工况下可能发生，最近 3 年内 2 次 · 2 = 可能性较小，最近 3 年内 1 次 · 1 = 几乎不发生，距今 3 年以上。","<strong>严重度 A（表 J-2b），1–5 级</strong>，按四类后果分列 — 人员（作业人员与公众）· 设备 · 材料 · 环境/公共设施。以 4 级为例：1 人死亡或 1 人永久伤残；1 台主要设备完全损坏并导致停工 1 周；材料损坏需 1 周重新采购并导致停工；产生污染但无公众投诉，或造成动植物生态破坏，或周边社区资产/道路通行部分损坏，或<strong>交通拥堵 1–2 小时</strong>。3 级对应多人住院治疗、停工不足 7 天、拥堵 30 分钟–1 小时。","<strong>就高原则：</strong>工程包同时满足多项判定条件时，一律按<strong>较高</strong>风险等级确定（第 34 条第 6 款）。在表 J-1 评价中，若至少 <strong>3</strong> 项作业内容评定为更高等级，则取更高等级。","风险等级由<strong>发包方</strong>以其正式函头签发确定（附件 J.1）。其唯一用途是确定所需安全人员配置 — 明确<em>不</em>用于衡量工程复杂度或市场分级。"]},
      {h:"安全人员配备比例与资格（部长条例 PUPR 10/2021 第 35–38 条）",
       table:{center:true,cols:["风险等级","安全人员 : 施工人数","最低资格要求"],
         rows:[
           ["<strong>小</strong>","<strong>1 : 60</strong>","每项工程至少配 <strong>1 名安全员</strong>（Petugas Keselamatan Konstruksi）"],
           ["<strong>中</strong>","<strong>1 : 50</strong>","至少配 <strong>1 名施工 K3 专家和/或初级施工安全专家</strong>"],
           ["<strong>大</strong>","<strong>1 : 40</strong>","至少配 <strong>1 名初级施工 K3 专家和/或具 ≥ 3 年经验的初级施工安全专家</strong>"],
           ["<strong>大且 &gt; 100 人</strong>","1 : 40","至少 <strong>2 名</strong>：(a) 1 名高级专家，或具 ≥ 3 年经验的中级专家；<strong>且</strong> (b) 1 名具 ≥ 3 年经验的初级专家"],
           ["大风险 — 递增配备","—","<strong>每增加 40 名工人，增配 1 名安全员</strong>"]
         ]},
       notes:["UKK 组成（第 37 条）：施工安全专家 · 施工 K3 专家 · 施工安全/K3 安全员 · 应急人员 · <strong>消防人员</strong> · 急救（P3K）人员 · 交通指挥人员 · 医护人员 · 环境管理人员。前三类须由<em>职业资格认证机构</em>颁发能力证书，其余由主管部门颁发。","UKK 架构（第 35–36 条）：UKK 向承包方最高负责人下属的安全管理单元负责，由负责人与成员组成。UKK 负责人须持有 K3/施工安全能力证书。<strong>小风险</strong>时项目最高负责人可兼任 UKK 负责人；<strong>中、大风险</strong>时必须设立<em>独立于</em>项目组织架构的 UKK。","对劳动密集型（padat karya）工程 — 用工多而机械少 — 安全人员需求改由 RKK 确定（第 34 条第 7 款）。"]},
      {h:"SMKK 费用九项组成（部长条例 PUPR 10/2021 附件 K.2）",
       table:{center:true,cols:["#","组成","包含内容"],
         rows:[
           ["1","<strong>RKK 编制</strong>","RKK 文件、程序与作业指导书，以及 SMKK 实施报告（日报、周报、月报、最终报告）"],
           ["2","<strong>宣贯、宣传与培训</strong>","安全交底 · 安全讲话 · 安全例会/安全讲座/班组会 · 安全巡查 · 安全培训 · 艾滋病防治宣传 · 应急演练 · 横幅 · 海报 · K3 信息栏"],
           ["3","<strong>作业防护（APK）与个体防护（APD）</strong>","<em>APK：</em>安全网、生命绳、防坠平台、防护栏杆、危险区域围挡、防坠器、防灾器材。<em>APD：</em>安全帽、护目镜、面屏、呼吸器、耳塞/耳罩、口罩、手套、安全鞋（含胶鞋与包头鞋）、全身式安全带、救生衣、反光背心、围裙/连体服"],
           ["4","<strong>保险与许可</strong>","保险；为取得设备准用证而进行的检验与试验"],
           ["5","<strong>施工安全人员</strong>","K3/施工安全专家 · 安全员 · 应急人员 · 急救员 · 交通指挥/举旗员 · 医护人员 · 环境管理人员"],
           ["6","<strong>设施、场所与医疗器材</strong>","急救箱（药箱、体温计、担架、敷料）· 急救室（病床、氧气瓶、听诊器、体重秤、血压计）· 消杀设备 · 传染病防疫费用（洗手设施、检测、维生素）"],
           ["7","<strong>标识标牌</strong>","灭火器位置、危险区域与危险品标识 · 临时作业标志 · 疏散路线 · 指挥棒 · 交通锥 · 旋转警示灯 · 临时道路设施（标志、标线、控制装置）"],
           ["8","<strong>专家咨询</strong>","按作业范围与现场需要聘请相关专家咨询"],
           ["9","<strong>风险控制活动与器材</strong>","作业环境检测（水、噪声、B3 废物、振动）· 灭火器 · 警报器 · 避雷装置 · 风速仪 · K3 旗 · 应急照明 · 采样与检测 · 工人身份卡（KIP）· <strong>外部审核</strong> · 视频监控"]
         ]},
       notes:["APK 与 APD 必须为<strong>全新</strong>并符合现行标准。安全人员最低数量由发包方在招标文件中确定。专家咨询（第 8 项）对<strong>大、中风险</strong>工程为强制要求，小风险工程按需实施。","该费用在工程量清单中单列；总价合同下作为 SMKK 产出组成列示 — 使安全投入不参与竞争性压价。"]},
      {h:"现场标识规范 — 安全帽颜色与设备标识（附件 K.2）",
       table:{center:true,cols:["角色 / 单元","安全帽标准"],
         rows:[
           ["来访者（tamu）","纯<strong>白色</strong>"],
           ["施工员（Pelaksana）","纯白 + <strong>1 道条纹</strong>（8 mm）"],
           ["施工负责人（Kepala Pelaksana）","纯白 + <strong>2 道条纹</strong>（2 × 8 mm）"],
           ["工程总负责人","纯白 + <strong>3 道条纹</strong>（各 8 mm）+ 顶部 <strong>1 道 15 mm</strong> 条纹"],
           ["施工安全单元（UKK）人员","<strong>红色</strong>"],
           ["土建作业单元","<strong>黄色</strong>"],
           ["机电（ME）作业单元","<strong>蓝色</strong>"],
           ["环境作业单元","<strong>绿色</strong>"],
           ["企业标识","置于安全帽正前方中央"]
         ]},
       notes:["施工作业人员着<strong>橙色</strong>工装。运行中的重型设备须张贴操作人员姓名、操作证（SIO）及 <strong>8R 尺寸照片</strong>。","安全员由已接受内部 K3/施工安全培训的工人协助工作。"]},
      {h:"自动判定为大风险的工程类型（部长条例 PUPR 10/2021 附件 J.2）",
       table:{cols:["工程类型","判定门槛 — 无须再行风险计算"],
         rows:[
           ["桥梁（Jembatan）","跨度 <strong>≥ 45 m 混凝土</strong> 或 <strong>≥ 50 m 钢结构</strong>"],
           ["跨线桥（Flyover / Overpass）","长度 <strong>&gt; 1,000 m</strong>"],
           ["特殊桥型 / 高架路","悬索、斜拉或拱式且跨度 ≥ 60 m；跨度 ≥ 100 m；<strong>桥墩高 &gt; 40 m</strong>；箱梁；及其他特殊设计结构。含 PISEW 计划吊桥"],
           ["高速公路（Jalan Bebas Hambatan）","平原 LHR ≥ 156,000 · 丘陵 ≥ 153,000 · 山区 ≥ 146,000"],
           ["公路（Jalan Raya）","平原 LHR ≥ 110,000 · 丘陵 ≥ 106,600 · 山区 ≥ 103,400"],
           ["丘陵与山区道路","全部"],
           ["隧道 · 下穿道 · 大坝 · 围垦 · 防波堤 · 潜坝（Groundsill）","全部 — 自动判定为大风险"]
         ]},
       notes:["凡列入本表的工程类型，风险等级直接确定为<strong>大</strong>，无须再进行表 J-1 评分。分类依据印尼建筑服务法 UU 2/2017 的业务分类。"]},
      {h:"运行控制与环境管理（部长条例 PUPR 10/2021 附件 D.2 要素 4）",
       table:{cols:["方面","控制要求"],
         rows:[
           ["机械与起重","起重机械、运输机械及其他施工设备的作业程序，须具备设备准用证与操作人员执照"],
           ["作业安全","作业系统安全程序/作业指导书；现场治安；发现危险状况时的<strong>停工程序</strong>"],
           ["个体防护","APD 使用程序/指导书；APD 与 APK 采购须在 RKK 中列明"],
           ["供应链","分包商与供应商控制，与 RMPK 衔接"],
           ["职业健康","全体施工人员的社会保障 + 员工健康检查"],
           ["环境","防污染程序；<strong>5R</strong> 现场整理（整理、整顿、清扫、清洁、素养）；废弃物与废水处理；再利用/减量/再循环改进 — 纳入 RKPPL"],
           ["应急","与工程性质及分类相匹配的应急响应程序"],
           ["调查","事故、危险事件及职业病的调查程序"]
         ]},
       notes:["建筑可靠性管理与 RMPK 衔接；场界治安与交通管制与 RMLLP 衔接；环境控制与 RKPPL 衔接 — 各 SMKK 文件之间明确相互引用，不是彼此孤立的。"]},
      {h:"现场治安、文明施工与废弃物（部长条例 PUPR 10/2021 附件 D.2）",
       table:{cols:["项目","最低要求"],
         rows:[
           ["保安人员","数量按治安风险控制需要配置"],
           ["视频监控","<strong>大风险</strong>且存在犯罪风险的作业区域尤须设置"],
           ["安全围挡","设于与周边社区直接相邻且存在事故风险的部位"],
           ["出入证（ID Card）","<strong>全部</strong>作业人员、来访者、供应商及其他进入施工区域的相关方均须佩戴"],
           ["现场整理（5R）","整理 · 整顿 · 清扫 · 清洁 · 素养 — <strong>每日至少一次，于当日作业结束时进行</strong>，由施工安全负责人与施工负责人/管理者代表签署"],
           ["垃圾分类","按<strong>有机 / 无机 / 危险废物（B3）</strong>分设容器 — <strong>每个作业区至少设 1 处</strong>"],
           ["临时堆放点","设临时收集点，同样按有机、无机、B3 分类"],
           ["环境监测","作业环境职业安全健康阈值测量（表 4-4）：监测参数、<strong>阈限值 NAB</strong>、依据法规与监测周期 — 填入《环境检查报告》"]
         ]},
       notes:["应急准备（D.3）要求编制与工程性质及分类相匹配的书面应急响应程序，由相应专业技术专家与施工安全负责人签署；并须编制涵盖事故、危险事件与职业病的事故调查程序。"]},
      {h:"国际对标 — HSE 管理体系",
       table:{cols:["🇮🇩 印尼（SMKK）","🇺🇸 美国","🇨🇳 中国"],
         rows:[
           ["部长条例 PUPR 10/2021 — SMKK","OSHA 29 CFR 1926（建筑业）+ ISO 45001","GB/T 45001 · GB 50656-2011《施工企业安全生产管理规范》"],
           ["RKK — 施工安全计划","现场专项安全计划（SSSP）/ 安全健康纲要","安全生产管理计划 / 施工组织设计（安全专章）"],
           ["IBPRP 危险源辨识与风险评价","工作危害分析（JHA / AHA）","危险源辨识与风险评价（JGJ 59-2011 检查评分）"],
           ["AKK + 专项作业许可（中/大风险）","作业许可：受限空间、动火、开挖、上锁挂牌","危险性较大的分部分项工程专项施工方案（超过一定规模须专家论证）"],
           ["UKK — 施工安全单元","主管人员 / 现场安全经理","专职安全生产管理人员（按合同额与面积配备）"],
           ["层级：消除→替代→工程→管理→个体防护","NIOSH 控制层级（同为 5 级）","消除→替代→工程控制→管理控制→个体防护"],
           ["安全费用单列计价（9 项组成）","投标清单中安全费用单列","安全文明施工费 — 法定不可竞价"]
         ]},
       notes:["SMKK 费用为<strong>单独计价、据实支付</strong>的项目 — 部长条例 PUPR 10/2021 要求 SMKK 实施费用至少包含 9 项组成，且不计入专家酬金预算，从而避免安全投入在投标中被压价。"]}
    ],
    sources:"部长条例 PUPR 10/2021 — 第 1–100 页：附件 A（发包方/承包方职责、UKK）、B（PMPM）、C（SMKK 概念设计 — 表5 风险评分、表6 IBPRP、表8 人员）、D（RKK 格式与五要素）· 第 100–200 页：A.3–A.4（领导承诺、表1-2 巡视计划、表1-3 员工参与）、B.1–B.3（表2-2 完整 IBPRP 含剩余风险、表2-3/2-4 目标与方案、表2-5 法规清单）、C.1–C.5（表3-1 设备、3-2 进口材料、3-3 人员、3-4 培训、3-5→3-8 沟通）、D.1–D.3（表4-1 程序清单、4-2 AKK/CSA、4-3 作业许可、4-4 环境阈值）、E（巡检、检查表、审核）· 第 200–300 页：F/表6-1（咨询服务报告）、G（RKPPL — 表2.1 按桩号的环境本底、表3.1 环境工作计划、AMDAL/UKL-UPL 衔接规则）、H（RMLLP — 13 项交通要素、表3 部门协调、表5 封路计划、每日观察义务）、I（报告矩阵 — 日/周/月报期限、份数与审批链）· 第 300–414 页：J（表 J-2a 频率、J-2b 严重度、<strong>表 J-3 风险矩阵 1-4/5-12/15-25</strong>、J.2 自动大风险工程清单）、K.2（<strong>SMKK 费用九项组成</strong>、安全帽颜色规范、设备标识）及正文第 33–38 条（按概算/人数/技术水平的法定风险判定、UKK 组建、<strong>人员配备比 1:60 / 1:50 / 1:40</strong>）— <strong>全文 414 页已完整覆盖</strong> · UU 1/1970 · 印尼建筑服务法 UU 2/2017 · UU 11/2020 · PP 14/2021 · ISO 45001 · OSHA 29 CFR 1926 · GB 50656-2011 / JGJ 59-2011"
  },

  environmental:{
    title:"环境质量标准与环境许可 — PP 22/2021",
    sections:[
      {h:"环境批准体系（PP 22/2021 — Persetujuan Lingkungan）",
       table:{center:true,cols:["层级","文书","适用情形","产出"],
         rows:[
           ["<strong>AMDAL</strong>","环境影响分析（Analisis Mengenai Dampak Lingkungan Hidup）","对环境产生<strong>重大影响</strong>的经营活动（强制 AMDAL）","<strong>《环境可行性批准》</strong> — 经环境可行性审查组（TUK）审查后核发"],
           ["<strong>UKL-UPL</strong>","环境管理与监测措施","无重大影响但仍须管理与监测的活动","<strong>《环境管理承诺声明批准（PKPLH）》</strong>"],
           ["<strong>SPPL</strong>","环境管理与监测承诺函","影响轻微／小规模活动","登记备案的承诺函"],
           ["<strong>PERTEK</strong>","技术批准（Persetujuan Teknis）","在上述文书之外，针对废水排放、大气排放、B3 危险废物管理及向海排放另行要求","技术批准，其后以《运营合格证 SLO》确认"]
         ]},
       notes:["<strong>环境批准是营业许可（Perizinan Berusaha）的前置条件</strong> — 须先取得环境批准方可核发经营许可（PP 22/2021，系 UU 32/2009 经 UU 11/2020《创造就业法》修订后的实施条例）。","AMDAL 文件由《工作大纲表》→《ANDAL》→《RKL-RPL》构成，并按影响规模与复杂程度分为 A、B、C 三类。一般固体废物提交《技术细则（Rincian Teknis）》即可，无须完整 PERTEK。"]},
      {h:"保护区 — AMDAL 筛查触发条件（PP 22/2021 附件 I 第一部分）",
       notes:["共 23 类法定保护区。项目是否位于其中属于筛查问题，直接计入下方 AMDAL 类别评分；在某些情形下，无论规模大小均据此判定必须编制 AMDAL。"]},
      {h:"AMDAL A / B / C 类判定评分体系（附件 I 第四部分）",
       notes:["四项准则各计 1–3 分，合计 4 至 12 分：<strong>&gt; 9 为 A 类</strong>、<strong>6–9 为 B 类</strong>、<strong>&lt; 6 为 C 类</strong>。附件 I 另含第二部分（筛查前提交的初始环境信息摘要）、第三部分（判定是否必须编制 AMDAL 的筛查程序）与第五部分（AMDAL 豁免办理程序）。"]},
      {h:"AMDAL 与 UKL-UPL 表格填报指南（附件 II 与 III）",
       table:{cols:["附件","文件","指南涵盖内容"],
         rows:[
           ["<strong>附件 II</strong>","<strong>工作大纲表</strong>（ANDAL 研究的工作范围）","工作大纲表的目的与作用 — 界定 ANDAL 研究的范围与深度；ANDAL 与 RKL-RPL 文件的受理与评审；内容实质性评审；评审与修改时限；以及可行性审查推荐意见的出具。含项目阶段审查指南、文件质量审查指南及 RKL-RPL 详细评审指南。"],
           ["<strong>附件 III</strong>","<strong>UKL-UPL 表格</strong>","项目责任人身份；拟建项目说明；产生的环境影响及管理与监测承诺；承诺声明书；参考文献；附件。同时涵盖已提交 UKL-UPL 表格的受理与审查。"]
         ]},
       notes:["工作大纲表在研究开始前即锁定 ANDAL 研究的<em>范围与深度</em> — 该环节出错是 AMDAL 被退回最常见的原因。UKL-UPL 表格是标准表格而非研究报告：C 部分填报的环境承诺在 PKPLH 核发后即成为具有法律约束力的条件。"]},
      {h:"环境可行性审查组 TUK（PP 22/2021 附件 IV）",
       notes:["TUK 负责对 AMDAL 开展可行性审查，并出具作为《环境可行性批准》依据的推荐意见。依核发批准的主管层级，分别在中央、省或县/市级组建。"]},
      {h:"导致环境批准变更的情形（附件 V）",
       notes:["共 13 类变更。凡新增负面影响或加大既有负面影响规模的变更，须编制 <strong>ANDAL 与 RKL-RPL 附录</strong>（按变更程度分三种类型）。附件 V 另含 DELH/DPLH 程序，适用于已运营但无环境文件的项目 — 即事后补办合规的路径。"]},
      {h:"水体功能类别（PP 22/2021 附件 VI）",
       table:{center:true,cols:["类别","功能用途"],
         rows:[
           ["<strong>I 类</strong>","饮用水水源，以及对水质要求相同的其他用途"],
           ["<strong>II 类</strong>","水上娱乐设施、淡水养殖、畜牧、农田灌溉，以及对水质要求相同的其他用途"],
           ["<strong>III 类</strong>","淡水养殖、畜牧、农田灌溉，以及对水质要求相同的其他用途"],
           ["<strong>IV 类</strong>","农田灌溉，以及对水质要求相同的其他用途"]
         ]},
       notes:["水体所属类别决定了下方表格中哪一栏构成对该水体的取水或排放的达标限值。破折号（—）表示该类别未规定此参数。"]},
      {h:"河流水质标准（PP 22/2021 附件 VI-I）— 完整表格",
       notes:["按法规原样复现，49 项参数 × 4 个类别。点击<strong>导出到 Excel</strong> 可下载当前所选语言的表格。"]},
      {h:"湖泊水质标准（PP 22/2021 附件 VI-II）— 完整表格",
       notes:["湖泊表增加了<em>透明度</em>与<em>叶绿素 a</em>，且营养盐限值严于河流表 — 总氮 0,65 / 0,75 / 1,90 mg/L，总磷 0,01 / 0,03 / 0,1 mg/L — 体现湖泊对富营养化的敏感性。"]},
      {h:"环境空气质量标准（PP 22/2021 附件 VII）— 完整表格",
       notes:["PP 22/2021 大幅收紧了原 PP 41/1999 的限值，并新增 <strong>PM₂,₅</strong> 与年均时段。与施工密切相关的关键值：<strong>TSP 24 小时 = 230 µg/m³</strong>、<strong>PM₁₀ 24 小时 = 75 µg/m³</strong>、<strong>PM₂,₅ 24 小时 = 55 µg/m³</strong> — 现场扬尘控制即以此为准。"]},
      {h:"海水水质标准（PP 22/2021 附件 VIII）— 完整表格",
       notes:["三类功能区：<em>港口（Pelabuhan）</em>、<em>海洋旅游（Wisata Bahari）</em> 与 <em>海洋生物（Biota Laut）</em>。海洋生物栏在法规区分之处另列 <strong>珊瑚（coral）</strong>、<strong>红树林（mangrove）</strong> 与 <strong>海草（lamun）</strong> 的分项限值 — 适用于围填海、栈桥、排放口及疏浚作业。"]},
      {h:"B3 危险废物名录 — 代码与危害类别（PP 22/2021 附件 IX）",
       notes:["合计四张表、约 314 个代码。本表完整收录表 1（非特定来源 — 几乎所有工地都会产生的溶剂、酸碱与通用废物）与表 4（特定专门来源 — 矿渣、灰渣、氧化铁皮、尾矿）。","须与非 B3 名录对照阅读：<strong>同一种物料因产生工艺不同，可能属 B3 也可能属非 B3</strong>。链条炉排锅炉产生的粉煤灰为 B409（B3）；采用其他技术的电厂产生的粉煤灰则为 N106（非 B3）。"]},
      {h:"B3 危险废物 — 六项特性（PP 22/2021 附件 X）",
       table:{center:true,cols:["#","特性","判定准则"],
         rows:[
           ["1","<strong>易爆</strong>（mudah meledak, E）","在标准温度与压力（25 °C、760 mmHg）下可发生爆炸，或经化学和/或物理反应产生高温高压气体并迅速破坏周围环境的废物"],
           ["2","<strong>易燃</strong>（mudah menyala, I）","含醇量 &lt; 24%（体积）和/或闪点 ≤ 60 °C（140 °F）的液态废物，在 760 mmHg 下接触明火或火花即燃 — 采用 Seta 闭口杯或 Pensky-Martens 闭口杯法测定；或非液态废物在 25 °C 下因摩擦、吸湿或自发化学变化而燃烧"],
           ["3","<strong>反应性</strong>（reaktif, R）","通常不稳定并剧烈反应但不爆轰；遇水剧烈反应；与水形成潜在爆炸性混合物；或产生足以危害人体健康或环境的有毒气体、蒸气或烟雾"],
           ["4","<strong>感染性</strong>（infeksius, X）","含有足以传播疾病的病原体浓度或数量的医疗与实验室废物 — 人体组织、培养物、锐器及感染性诊疗产生的废物"],
           ["5","<strong>腐蚀性</strong>（korosif, C）","pH ≤ 2（酸性）或 pH ≥ 12,5（碱性）的废物，或在 55 °C 下对钢的腐蚀速率超过 6,35 mm/年"],
           ["6","<strong>毒性</strong>（beracun, T）","通过 TCLP 浸出试验、LD50 经口毒性试验及亚慢性毒性评价判定 — TCLP 限值见附件 XI（下方表格）"]
         ]},
       notes:["废物若列入 B3 清单，或经检测具备上述任一特性，即判定为 B3 危险废物。毒性分为 <strong>第 1 类</strong>（急性 — 高于 TCLP-A）与 <strong>第 2 类</strong>（慢性 — 介于 TCLP-A 与 TCLP-B 之间），并据此决定其后的贮存、运输、处理与填埋全套要求。"]},
      {h:"B3 危险废物类别判定 TCLP 限值（附件 XI）— 完整表格",
       notes:["涵盖无机物、阴离子、有机物、农药及附加参数共 72 项污染物。高于 TCLP-A 判为第 1 类；介于 TCLP-A 与 TCLP-B 之间判为第 2 类。"]},
      {h:"填埋前处理 TCLP 标准（附件 XII）— 完整表格",
       notes:["附件 XII 的数值与附件 XI 的 TCLP-B 栏一致 — B3 危险废物须处理至该浸出浓度方可进入最终填埋设施（penimbusan akhir）。"]},
      {h:"污染土壤限值 — TCLP 与总浓度（附件 XIII）— 完整表格",
       notes:["六栏将浸出限值（TCLP）与总浓度限值（TK）按 A/B/C 三个严重程度配对。该表用于因泄漏或历史处置造成的土地污染修复 — 当项目场地曾有工业用途时尤为相关。"]},
      {h:"已登记非 B3 废物（附件 XIV）— 完整表格",
       notes:["PP 22/2021 的重大变化：燃煤电厂的<strong>粉煤灰与炉底渣（FABA）</strong>从 B3 清单移出，列入已登记非 B3 类别，同类还有钢渣与镍渣、氧化铁皮、电弧炉粉尘及废白土。非 B3 废物通过环境批准中的技术细则管理，无须完整 PERTEK。"]},
      {h:"违规行为与处罚分级（PP 22/2021 附件 XV）",
       table:{center:true,cols:["违规领域","条目数","适用分级"],
         rows:[
           ["<strong>表 1</strong> — 水污染防治","约 55 条","轻微 · 中等 · 严重"],
           ["<strong>表 2</strong> — 大气污染防治","约 60 条","轻微 · 中等 · 严重"],
           ["<strong>表 3</strong> — 海洋污染防治","约 40 条","轻微 · 中等 · 严重"],
           ["<strong>表 4</strong> — B3 危险废物管理","约 126 条","轻微 · 中等 · 严重，并区分产生者（Penghasil）与服务方（Jasa）"]
         ]},
       notes:["<strong>轻微（Ringan）</strong> — 行政与记录类缺失：监测点未标注名称与坐标、污染防治负责人无能力证书、污水处理设施操作人员无证、未建立环境管理体系。","<strong>中等（Sedang）</strong> — 监测与控制的实质性缺失：未在指定达标点监测废水水质、根本未设达标点、未监测地表水/地下水/土壤、无水污染应急系统、未使用注册实验室、应装未装连续自动监测装置。","<strong>严重（Berat）</strong> — 超标排放、未取得所需批准即运营，以及（表 4）超出排放或非 B3 废物利用标准。分级决定所适用的行政处罚：书面警告 → 政府强制 → 暂停 → 吊销营业许可（Perizinan Berusaha）。","该附件列举约 280 项逐条编号的违规行为。此处归纳分级框架及各等级代表性条目；在执法情境下援引具体条目前，请查阅官方附件 XV 完整清单。"]},
      {h:"施工相关的合规要点",
       table:{cols:["作业活动","标准控制的内容"],
         rows:[
           ["基坑降水／向河流排放","排水不得使受纳水体超出其类别限值（附件 VI）— 通常以 TSS、pH、石油类与油脂及重金属为控制性参数"],
           ["土方工程与运输道路","环境扬尘对照 TSP / PM₁₀ / PM₂,₅（附件 VII）；洒水与车轮冲洗为常规缓解措施"],
           ["混凝土搅拌与破碎","环境颗粒物及设备产生的 SO₂/NO₂；固定源须办理排放 PERTEK"],
           ["涉海工程 — 栈桥、围填海、疏浚、排放口","按所定海水功能区适用附件 VIII 限值，涉及珊瑚/红树林/海草时适用其分项限值"],
           ["燃油与化学品储存","按 PERTEK 实施 B3 危险废物管理；设围堰防溢以使石油类与油脂维持在限值内"],
           ["现场生活污水","适用生活污水排放标准及受纳水体的类别限值"]
         ]},
       notes:["在施工项目上，本标准与 SMKK 环境文件相互衔接：<strong>RKPPL</strong> 环境管理计划必须承接并细化由本条例导出的 RKL-RPL 或 UKL-UPL 承诺（部长条例 PUPR 10/2021 附件 G）。"]},
      {h:"国际对标 — 环境空气与水",
       table:{cols:["参数","🇮🇩 PP 22/2021","🇺🇸 美国 EPA NAAQS","🇨🇳 GB 3095-2012（二级）"],
         rows:[
           ["PM₂,₅ — 24 小时","<strong>55 µg/m³</strong>","35 µg/m³","75 µg/m³"],
           ["PM₂,₅ — 年均","<strong>15 µg/m³</strong>","9 µg/m³（2024）","35 µg/m³"],
           ["PM₁₀ — 24 小时","<strong>75 µg/m³</strong>","150 µg/m³","150 µg/m³"],
           ["PM₁₀ — 年均","<strong>40 µg/m³</strong>","—","70 µg/m³"],
           ["SO₂ — 24 小时","<strong>75 µg/m³</strong>","—","150 µg/m³"],
           ["NO₂ — 年均","<strong>50 µg/m³</strong>","100 µg/m³","40 µg/m³"],
           ["CO — 8 小时","<strong>4.000 µg/m³</strong>","10 mg/m³（9 ppm）","4.000 µg/m³"],
           ["地表水分类","I–IV 类","美国按州确定功能用途","GB 3838-2002 I–V 类"]
         ]},
       notes:["印尼的 PM₁₀ 与 PM₂,₅ 年均限值明显严于中国二级标准（PM₁₀ 24 小时亦严于美国标准），而 PM₂,₅ 的 24 小时限值则宽于美国。若项目另有贷款方或母公司要求（IFC EHS 导则、WHO 空气质量准则），通常以适用值中<strong>较严者</strong>为准。"]}
    ],
    sources:"PP 22/2021 附件 VI（国家水质标准 — I. 河流、II. 湖泊）、附件 VII（环境空气质量标准）、附件 VIII（海水水质标准）— 自官方 PDF 转录并逐项参数核对 · PP 22/2021 正文（环境批准、AMDAL/UKL-UPL/SPPL、技术批准） · UU 32/2009 · UU 11/2020《创造就业法》 · 部长条例 PUPR 10/2021 附件 G（RKPPL 衔接） · 美国 EPA NAAQS · GB 3095-2012 / GB 3838-2002 · IFC EHS 导则"
  }
};
