...
var TOPIC_ZH={
  ...
  steel_structure:{name:"钢结构",kw:["钢结构","钢材","焊接","螺栓","抗弯框架","支撑","屈曲","稳定","型钢","受压构件","受拉构件","受弯构件","钢柱","钢梁","弯曲屈曲","弯扭屈曲","临界应力","塑性弯矩","截面分类","厚实","宽厚比","剪力滞后","抗力系数","长细比","块状剪切","承压","撕裂","摩擦型","预拉力","角焊缝","坡口焊","组合构件","组合柱","组合梁","栓钉","抗剪连接件","节点板","边距","钢管混凝土"]},
...
var MOD_ZH={
  ...
  steel:{
    ...
    sources:"SNI 1729:2020（= AISC 360-16）：B3/B4 章（φ/Ω、分类）、D 章（受拉）、E3 章（受压 Fcr）、F2 章（受弯 Mp/Lp/Lr/Cb）、G2 章（受剪）、H1 章（组合）、I 章（组合构件、I8 栓钉）、J2 章（焊缝）、表 J3.2（螺栓）、J3（承压/摩擦）、J4 章（块状剪切）— 提取自 PDF · AISC 360-22 表 B4.1、J3.2、J2.5 · AISC 341-22（抗震） · GB 50017-2017（Q 牌号、设计强度 f = fy/γR、§11 连接）"
  },
  geotechnical:{
    title:"岩土与地基 — 设计参数",
    sections:[
