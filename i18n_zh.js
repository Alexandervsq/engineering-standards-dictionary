  ...
  hse:{
    ...
    sections:[
      ...
      {h:"IBPRP 评分与剩余风险 — 16 栏表格（部长条例 PUPR 10/2021 表 2-2）",
       ...
       notes:["可能性/发生频率 = 施工安全危险事件发生的频繁程度（1–5 级）。严重度 = 危险源造成的伤害、损失或破坏程度（1–5 级）。风险等级为两者的组合。","部里官方算例（表 2-2 示例，钢箱梁运输）中的分档：2、3、4 → <strong>小</strong>；6、9、12 → <strong>中</strong>；16 → <strong>大</strong>。正式判定准则表见附件 J。","IBPRP 由施工负责人签署。控制层级定义（部长条例 PUPR 10/2021）：<em>消除</em> = 不安排人员从事该作业以消除危险；<em>替代</em> = 更换工艺、操作、材料或设备；<em>工程技术</em> = 通过设备与作业场所的设计进行控制；<em>管理控制</em> = 程序、作业许可、作业安全分析与能力提升；<em>APD/APK</em> = 配备充分的个体与作业防护装备。"]},
