...
var TOPIC_ZH={
  ...
  structural_concrete:{name:"结构混凝土",kw:["混凝土","钢筋","保护层","柱","梁","板","剪力墙","配筋","强度等级","砼","强度折减系数","受拉控制","受压控制","净受拉应变","等效应力图","耐久性","暴露等级","硫酸盐","冻融","氯化物","水胶比","抗折模量","混凝土墙","墙厚","承重墙","基础设计","独立基础","承台","筏板","基础厚度","单向受剪","梁受剪"]},
