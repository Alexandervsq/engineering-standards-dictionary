...
var MOD_ZH={
  ...
  wind:{
    ...
    sources:"SNI 1727:2020 表 26.6-1（Kd）、§26.7（暴露）、表 26.10-1（Kz）、表 26.11-1（zg/α）、表 26.13-1（GCpi）、图 27.3-1（Cp）、§26.10.2 与 §27.1.5（最小风压）— 提取自 PDF · = ASCE 7-16 第26–27章 · GB 50009-2012 §8.1（w₀）、表 8.2.1（μz）、§8.2.2（地貌/山地）、§8.4（βz）",
    tool_link_site:true
  },
  rain:{
    title:"雨荷载与降雨 — 设计参数",
