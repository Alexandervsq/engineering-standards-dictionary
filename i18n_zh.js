...
var TOPIC_ZH={
  ...
  structural_concrete:{name:"结构混凝土",kw:["混凝土","钢筋","保护层","柱","梁","板","剪力墙","配筋","强度等级","砼","强度折减系数","受拉控制","受压控制","净受拉应变","等效应力图","耐久性","暴露等级","硫酸盐","冻融","氯化物","水胶比","抗折模量","混凝土墙","墙厚","承重墙","基础设计","独立基础","承台","筏板","基础厚度","单向受剪","梁受剪","特殊抗弯框架","抗震构造","强柱弱梁","柱约束","塑性铰","加密区","箍筋间距","节点受剪","梁柱节点","约束箍筋","延性构造","抗震等级"]},
...
var MOD_ZH={
  concrete:{
    ...
    sources:"SNI 2847:2019 表 21.2.1 与 21.2.2（φ）、§22.2（β1、εcu）、§19.2–19.3（耐久性）、§22.5（受剪）、第7–9章（尺寸）、第11章（墙）、第13章（基础）、§18.6–18.8（SRPMK 梁/柱/节点）、表 18.7.5.4（约束）— 提取自 PDF · SNI 2052:2017（钢筋） · GB 50010-2010 与 GB 50011 · ACI 318-19（= SNI 2847）"
  },
  steel:{
    title:"钢结构 — 设计参数",
    sections:[
